            ...
            filteredEmployees.map((employee) => (
              <div key={employee.id} className="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all duration-300 flex flex-col">
                <div className="flex justify-center mb-4">
                  <img
                    src={employee.profilePhotoUrl || 'https://placehold.co/150x150/E2E8F0/A0AEC0?text=No+Image'}
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex flex-col items-center mb-6">
                  <img
                    src={selectedEmployee.profilePhotoUrl || 'https://placehold.co/150x150/E2E8F0/A0AEC0?text=No+Image'}
