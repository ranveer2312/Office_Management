  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-sans">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Main Content Card with transparency */}
        <div className="bg-white bg-opacity-70 backdrop-blur-lg rounded-xl shadow-2xl p-6 space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* The filter button is visually styled but not functional in this example */}
      ...
      {showViewModal && viewingDocument && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-8 w-full max-w-4xl relative">
            ...
            <div className="mb-6">
              <iframe
                src={APIURL + `/uploads/${viewingDocument.fileName}`}
