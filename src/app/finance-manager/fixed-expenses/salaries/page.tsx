...
import { PlusCircleIcon, TrashIcon, PencilSquareIcon, BriefcaseIcon, DocumentArrowUpIcon, DocumentTextIcon } from '@heroicons/react/24/outline';
...
export default function SalariesPage() {
  ...
  // Fixed API_URL - remove dependency on APIURL in useCallback
  ...
  }, [currentPage]); // Only depend on currentPage, not API_URL
