...
import { Calendar, BookOpen, ArrowLeft, Plus, Send, X } from 'lucide-react';
        ...
        <div className="flex space-x-1 mb-6">
          <button
            ...
            className={`px-4 py-2 rounded-lg flex items-center space-x-2 ${
              activeTab === 'calendar' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg flex items-center space-x-2 ${
              activeTab === 'skillrequest' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border'
            }`}
          >
            ...
            {trainings.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {trainings.map((training, index) => (
                  <div key={`training-${training.id}-${index}`} className="bg-white rounded-lg shadow-sm border p-6">
        ...
        {activeTab === 'skillrequest' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">My Skill Requests</h2>
              <button
            ...
            {skillRequests.length === 0 ? (
              ...
              <div className="space-y-4">
                {skillRequests.map((request, index) => (
                  <div key={`skillrequest-${request.id}-${index}`} className="bg-white rounded-lg shadow-sm border p-6">
                    <div className="flex items-center justify-between mb-4">
